#ifndef DirectedFlowCorrelatorTestBase_
#define DirectedFlowCorrelatorTestBase_
...
class DirectedFlowCorrelatorTest : public edm::EDAnalyzer {
   public:
      explicit DirectedFlowCorrelatorTest(const edm::ParameterSet&);
      ~DirectedFlowCorrelatorTest();
